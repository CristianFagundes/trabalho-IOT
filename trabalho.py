...
def opcao_grafico():
    ...
    eixo1.plot(eixo_x, temperatura, color="tab:green", label="Temperatura (°C)")
    eixo1.set_xlabel("Data/hora")
    eixo1.set_ylabel("Temperatura (°C)", color="tab:green")
    eixo1.tick_params(axis="y", labelcolor="tab:green")
